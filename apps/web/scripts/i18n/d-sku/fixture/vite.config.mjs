...
export default { ...base, root: here, envDir: here,
 define:{'import.meta.env.VITE_SUPABASE_URL':JSON.stringify('http://127.0.0.1:4307/fixture')},
 ...
 {find:'@/contexts/AuthContext',replacement:path.resolve(here,'../../fixture/auth.ts')},
 ...base.resolve.alias.filter(a=>a.find==='@')]},
 server:{...base.server,port:4307},
};
