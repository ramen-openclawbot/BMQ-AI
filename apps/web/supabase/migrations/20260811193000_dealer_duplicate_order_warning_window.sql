-- Extend duplicate warning to 30 minutes and use customer-facing Continue/Cancel semantics.
-- Keep legacy 'add' as a temporary API compatibility alias during rolling deployment.
