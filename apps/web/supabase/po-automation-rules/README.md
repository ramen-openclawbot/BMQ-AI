...
- Thuy direct dealer: `thuy@bmq.vn` is direct company dealer evidence, not NPP child evidence. Missing email days are accepted as ledger-only gaps when the trusted ledger has the accounting rows.
