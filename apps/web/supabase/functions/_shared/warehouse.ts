...
export function warehouseClient(base: string, authorization: string, signal: AbortSignal, fetcher: typeof fetch = fetch): WarehouseCall {
  ...
  return async (path, body) => {
    if (!new Set(["/v1/status", "/v1/sources", "/v1/ingest", "/v1/documents", "/v1/semantic", "/v1/query", "/v1/knowledge/search", "/v1/customer", "/v1/cost", "/v1/payment", "/v1/finance-media/search"]).has(path)) throw new WarehouseError("invalid_operation", 400);
