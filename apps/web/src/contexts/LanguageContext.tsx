...
const translations: Record<Language, Translations> = {
  en: {
    ...
    skus: "SKU Management",
    skuCosts: "COGS",
    skuCostDashboard: "COGS Dashboard",
    skuCostManagement: "Finished SKU Management",
    skuCostAnalysis: "COGS Analysis",
    ...
    sectionMarketingSales: "Sale & Marketing",
  ...
  vi: {
    ...
    skus: "Quản lý SKU",
    skuCosts: "Giá Vốn",
    skuCostDashboard: "Tổng quan giá vốn",
    skuCostManagement: "Quản trị SKU thành phẩm",
    skuCostAnalysis: "Phân tích giá vốn",
    ...
    sectionMarketingSales: "Bán Hàng và Tiếp Thị",
    ...
    q7MaterialInventory: "Xuất-nhập-tồn NVL Q7",
