      ...
      <div className="mx-auto max-w-7xl space-y-5">
        ...
        {!isLoading && !error && <>
          ...
          <Tabs defaultValue="materials" className="space-y-4">
            ...
            <TabsContent value="queue" className="space-y-4" data-bmq-material-master-resolution-queue><QueueActions requests={data?.resolutionRequests || []} materials={materials} canMutate={canMutate} /><ReconciliationQueue canMutate={canMutate} /></TabsContent>
