        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0">
              <p className="text-xs font-semibold uppercase tracking-[0.2em] text-amber-700">{pc.supplyPartners}</p>
              <h1 className="mt-1 text-2xl font-display font-bold text-slate-950 sm:text-3xl">
                 {pc.suppliers} </h1>
              <p className="mt-1 text-sm text-slate-600">
                 {pc.manageSupplierProfilesContactsContractsAndPaymentTerms} </p>
            </div>
          </div>
